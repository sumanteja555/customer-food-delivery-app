...
export default function RestaurantHomeScreen() {
  ...
  }, [search, selectedCategory, selectedServiceCity]);
...
const styles = StyleSheet.create({
  ...
  cartButton: { width: 44, height: 44, borderRadius: 15, backgroundColor: '#FFFFFF', borderWidth: StyleSheet.hairlineWidth, borderColor: '#E3DFD9', alignItems: 'center', justifyContent: 'center' },
