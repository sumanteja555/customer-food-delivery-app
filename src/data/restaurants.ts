...
export const RESTAURANTS: Restaurant[] = [
  {
    id: '6', city: 'Nandigama', name: 'Nandigama Spice Hub', cuisine: 'Indian · Biryani',
  ...
  {
    id: '7', city: 'Nandigama', name: 'Highway Tiffins', cuisine: 'Indian · South Indian',
  ...
  {
    id: '8', city: 'Jaggayyapeta', name: 'Jaggayyapeta Food Court', cuisine: 'Indian · Multi-cuisine',
  ...
  {
    id: '9', city: 'Jaggayyapeta', name: 'Sri Balaji Meals', cuisine: 'Indian · Andhra Meals',
  ...
  {
    id: '10', city: 'Kanchikacherla', name: 'Kanchikacherla Kitchen', cuisine: 'Indian · Andhra',
  ...
  {
    id: '11', city: 'Kanchikacherla', name: 'Village Pizza Point', cuisine: 'Pizza · Fast Food',
  ...
  {
    id: '12', city: 'Kodada', name: 'Kodad Biryani House', cuisine: 'Indian · Biryani',
  ...
  {
    id: '13', city: 'Kodada', name: 'NH65 Burger Stop', cuisine: 'Burgers · Fast Food',
